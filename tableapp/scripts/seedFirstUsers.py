from main.models import Users,Table
def run():
    ...
    # adminUser.save()
    User = Users(first_name="Martin", last_name="Olivera", username="fagot", password = "rjdgbjod", gender="M", height=186, activity_level = 3, role = "user", table_id=None)
    User.save()
    pair = Table.add_pair(1,1)